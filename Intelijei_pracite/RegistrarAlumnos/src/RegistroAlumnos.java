...
public class RegistroAlumnos {
    ...
    private void run() {
        while (true) { // ciclo infinito, se sale con opcion 0
            ...
            System.out.println("2. Consultar estudiante por RUT"); //solo las tres primeras fucionnan o lo que tiene
            System.out.println("3. Eliminar estudiante por RUT"); //que ver con el estudiante
            ...
            int op = leerEnteroLibre();                 // leemos entero sin rango op=opciones
