...
public class Registroinstituto {
    ...
    private void ingresarNotas() {
        ...
        asignatura_var.getNotaPresentacion();
        asignatura_var.setNotaExamen(0);
        asignatura_var.setNotaFinal(0);
    ...
    private void calcularPresentacion() {
        ...
        if (asignatura_var.getNota1() == 0.0 || asignatura_var.getNota2() == 0.0 || asignatura_var.getNota3() == 0.0) {
