...
public class mazodecartas {
    public static void main(String[] args) {
        ...
        while (opcion !=6){
            ...
            System.out.println("3) Bonificar Leyenda (+20% legendario + dragon");
            System.out.println("4) Contar Habilidades por maná");
            ...
            if (opcion == 1){
                ...
                System.out.println("Mana a contar (entero): ");
